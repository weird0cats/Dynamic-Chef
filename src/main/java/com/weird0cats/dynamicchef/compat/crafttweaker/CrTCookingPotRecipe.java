package com.weird0cats.dynamicchef.compat.crafttweaker;
...
public class CrTCookingPotRecipe implements ICookingPotRecipe
{
   ...
   public CrTCookingPotRecipe(@Nonnull ItemStack output, IIngredient[] inputs)
   {
      this(output, inputs, 400);
   }

   public CrTCookingPotRecipe(@Nonnull ItemStack output, IIngredient[] inputs, int time)
   {
      this.output = output;
